...
exports.isNumber = function (str) { return str != undefined && /^[0-9]*$/.test(str); };
exports.isPhone = function (str) { return str != undefined && /^1[3456789][0-9]{9}$/.test(str); };
exports.isCode = function (str) { return str != undefined && /^[0-9]{6}$/.test(str); };
exports.isBankcard = function (str) { return str != undefined && /^[0-9]{16,19}$/.test(str); };
